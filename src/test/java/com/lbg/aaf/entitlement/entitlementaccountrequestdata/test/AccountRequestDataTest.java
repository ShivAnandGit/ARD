...
import com.lbg.aaf.entitlement.entitlementaccountrequestdata.data.Account;
...
import com.lbg.aaf.entitlement.entitlementaccountrequestdata.data.AccountSchemeNameEnum;
import com.lbg.aaf.entitlement.entitlementaccountrequestdata.data.CreateAccountInputData;
import com.lbg.aaf.entitlement.entitlementaccountrequestdata.data.Permission;
import com.lbg.aaf.entitlement.entitlementaccountrequestdata.data.PermissionsEnum;
import com.lbg.aaf.entitlement.entitlementaccountrequestdata.data.Servicer;
import com.lbg.aaf.entitlement.entitlementaccountrequestdata.data.ServicerSchemeNameEnum;
...
public class AccountRequestDataTest<T> {
    ...
    public void getAccountRequestsTest() throws Exception {
        ...
        String sealectQuery = "SELECT * FROM   INFORMATION_SCHEMA.TABLES";
        List<Map<String, Object>> resultSet = jdbcTemplate.queryForList(sealectQuery);
        ...
        assertNotNull(accountRequestDataController.getAccountRequests("123", "adadsaas", request, response, "adf", "clientid").call().getBody());
    ...
    public void getAccountRequestForAccountIdTest() throws Exception {
        ...
        assertNotNull(accountRequestDataController.getAccountRequestForAccountId("123", "adadsaas", request, response, "adf").call().getBody());
    ...
    public void deleteAccountRequestForAccountIdTest() throws Exception {
        ...
        assertNull(accountRequestDataController.deleteAccountRequestForAccountId("123", "adadsaas", request, response, "123").call().getBody());
    ...
    public void getMockEntitlementsForProviderTest() throws Exception {
        ...
        assertNotNull(accountRequestDataController.createAccountRequests("123", "asd", "adf", createAccountInputData, request, response).call().getBody());
    }
}