...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
    ...
    <sch:pattern>
      ...
      <!-- Check httpEndpoint configuration -->  
        ...
        <!-- Check httpEndpoint configuration -->
            <sch:assert test="(@traceSpecification) = '*=info'">
                [ERROR] logging should be set to info &lt;logging traceSpecification="*=info"/&gt;
            </sch:assert>            
            ...
            <sch:assert test="(@consoleLogLevel) = 'OFF' or (@consoleLogLevel) = 'INFO' or (@consoleLogLevel) = 'AUDIT' ">
                [ERROR] consoleLogLevel should be OFF (this may also be set in the bootstrap.properties file: com.ibm.ws.logging.console.log.level=OFF)
            </sch:assert>
